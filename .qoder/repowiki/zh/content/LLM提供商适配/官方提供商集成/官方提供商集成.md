...
## 简介
本文件面向官方LLM提供商集成，系统性介绍OpenAI、Azure OpenAI、Anthropic Claude以及Ollama本地模型等官方提供商的完整集成实现。内容覆盖认证配置、API密钥管理、连接设置、特有参数、限制与性能特点、配置示例、错误处理与重试机制、使用示例与最佳实践，以及提供商间差异与迁移注意事项。目标是帮助读者从基础配置到高级优化建立完整的知识体系。
...
- [openai_provider.py](file://src/providers/openai_provider.py#L41-L82)
- [azure_provider.py](file://src/providers/azure_provider.py#L42-L83)
- [anthropic_provider.py](file://src/providers/anthropic_provider.py#L40-L82)
- [ollama_provider.py](file://src/providers/ollama_provider.py#L33-L118)
- [custom_openai_provider.py](file://src/providers/custom_openai_provider.py#L35-L122)
- [custom_anthropic_provider.py](file://src/providers/custom_anthropic_provider.py#L31-L96)
...
**章节来源**
- [openai_provider.py](file://src/providers/openai_provider.py#L13-L82)
- [config.py](file://src/config.py#L20-L24)
...
**章节来源**
- [azure_provider.py](file://src/providers/azure_provider.py#L13-L83)
- [config.py](file://src/config.py#L25-L29)
...
**章节来源**
- [anthropic_provider.py](file://src/providers/anthropic_provider.py#L13-L82)
- [config.py](file://src/config.py#L31-L35)
...
**章节来源**
- [ollama_provider.py](file://src/providers/ollama_provider.py#L13-L118)
- [config.py](file://src/config.py#L36-L39)
...
- [azure_provider.py](file://src/providers/azure_provider.py#L5-L10)
- [anthropic_provider.py](file://src/providers/anthropic_provider.py#L5-L10)
- [ollama_provider.py](file://src/providers/ollama_provider.py#L5-L10)
- [custom_openai_provider.py](file://src/providers/custom_openai_provider.py#L5-L10)
- [custom_anthropic_provider.py](file://src/providers/custom_anthropic_provider.py#L5-L10)
- [factory.py](file://src/providers/factory.py#L6-L11)
- [request.py](file://src/models/request.py#L3-L5)
- [document.py](file://src/models/document.py#L3-L5)
...
**章节来源**
- [base.py](file://src/providers/base.py#L22-L24)
- [openai_provider.py](file://src/providers/openai_provider.py#L66-L71)
- [anthropic_provider.py](file://src/providers/anthropic_provider.py#L66-L71)
- [ollama_provider.py](file://src/providers/ollama_provider.py#L68-L73)
...
**章节来源**
- [azure_provider.py](file://src/providers/azure_provider.py#L29-L31)
- [custom_openai_provider.py](file://src/providers/custom_openai_provider.py#L24-L25)
- [custom_anthropic_provider.py](file://src/providers/custom_anthropic_provider.py#L19-L21)
- [ollama_provider.py](file://src/providers/ollama_provider.py#L77-L91)
- [base.py](file://src/providers/base.py#L112-L143)
...
**章节来源**
- [.env.example](file://.env.example#L1-L22)
- [config.py](file://src/config.py#L20-L39)
- [factory.py](file://src/providers/factory.py#L14-L71)
...
**章节来源**
- [openai_provider.py](file://src/providers/openai_provider.py#L13-L36)
- [azure_provider.py](file://src/providers/azure_provider.py#L13-L37)
- [anthropic_provider.py](file://src/providers/anthropic_provider.py#L13-L35)
- [ollama_provider.py](file://src/providers/ollama_provider.py#L13-L29)

### 完整提供商支持矩阵

| 提供商 | 说明 | 需要API Key | 需要API Base | 默认模型 | 支持协议 |
|--------|------|------------|--------------|----------|----------|
| openai | OpenAI官方API | 是 | 否 | gpt-4 | OpenAI Chat Completions |
| azure | Azure OpenAI | 是 | 是 | gpt-4 | Azure OpenAI Chat Completions |
| anthropic | Anthropic Claude | 是 | 否 | claude-3-5-sonnet-20241022 | Anthropic Messages API |
| custom_openai | 自定义OpenAI协议 | 可选 | 是 | default | OpenAI兼容API |
| custom_anthropic | 自定义Anthropic协议 | 可选 | 是 | claude-3-sonnet | Anthropic兼容API |
| ollama | Ollama本地模型 | 否 | 可选 | llama2 | Ollama Generate API |

**章节来源**
- [README.md](file://README.md#L143-L152)
- [config.py](file://src/config.py#L20-L39)
...
#### 基础配置
- `default_temperature`: 0.1（较低温度提升确定性）
- `max_retries`: 3（统一重试次数）
- `default_chunk_size`: 3000（分块大小）
- `default_chunk_overlap`: 200（分块重叠）

#### OpenAI配置
- `openai_api_key`: OpenAI API密钥
- `openai_base_url`: 可选，自定义OpenAI端点
- `openai_default_model`: gpt-4

#### Azure OpenAI配置
- `azure_openai_api_key`: Azure OpenAI密钥
- `azure_openai_endpoint`: Azure资源端点
- `azure_openai_api_version`: API版本，默认2024-02-01
- `azure_openai_default_model`: gpt-4

#### Anthropic配置
- `anthropic_api_key`: Anthropic API密钥
- `anthropic_base_url`: 可选，自定义Anthropic端点
...
**章节来源**
- [config.py](file://src/config.py#L16-L53)