...
## 简介
本文件为命令行界面（CLI）的完整API文档，涵盖所有可用命令、参数与选项，提供参数详解、使用示例与最佳实践。同时对比CLI与Web服务的差异与适用场景，给出错误处理策略、调试技巧、常见使用模式与高级配置选项，兼顾初学者与有经验用户的阅读体验。
...
- [parser.py](file://api-doc-parser/src/api_doc_parser/core/parser.py#L1-L200)
...
章节来源
- [cli.py](file://api-doc-parser/src/api_doc_parser/cli.py#L25-L124)
- [README.md](file://api-doc-parser/README.md#L51-L76)
...
章节来源
- [README.md](file://api-doc-parser/README.md#L78-L94)
...
章节来源
- [cli.py](file://api-doc-parser/src/api_doc_parser/cli.py#L140-L231)
...
章节来源
- [cli.py](file://api-doc-parser/src/api_doc_parser/cli.py#L300-L323)
